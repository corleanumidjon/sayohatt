...
import photo from "../../../public/images/emirates.png"
  ...
  return (
    <div className='mt-4 flex lg:flex-row flex-col items-center justify-between bg-white rounded-xl shadow-md gap-y-4 px-6 py-8'>
      <div className="card-left lg:w-auto w-full flex md:flex-row flex-col gap-x-8 md:gap-y-0 gap-y-4">
        <Image className='my-auto md:max-w-[80px] w-full md:h-[80px] object-fill p-[8px] md:border rounded-lg border-[#8dd3bb]' src={photo} alt='' />
        <div className="flex md:flex-row flex-col w-full items-center md:gap-x-6 md:gap-y-0 gap-y-2">
           ...
           <div className="flex flex-col md:gap-y-2 gap-y-1">
                <span className='opacity-75 text-[#121] md:text-base text-sm'>Newark(EWR)</span>
                <h4 className='md:text-xl text-md font-semibold'>12:00 pm</h4>
            </div>
           <Divider className='min-w-[20px] max-w-[20px] h-[2px] bg-black'/>
            ...
            <div className="grid grid-cols-12 gap-y-2 md:w-auto w-full gap-x-6">
                <div className="col-span-6 flex items-center gap-x-2">
                   ...
                   <span className='text-[#121] md:text-xs text-[11px] font-semibold opacity-75'>Date</span>
                    <h5 className='text-[#121] md:text-base text-sm font-medium'>12-11-22</h5>
                   </div>
                </div>
                <div className="col-span-6 flex items-center gap-x-2">
                    <div className='md:p-[5px] p-1 bg-[#EBF6F2] rounded-[4px]'>
                   ...
                   <div className='flex flex-col'>
                   <span className='text-[#121] md:text-xs text-[11px] font-semibold opacity-75'>Gate</span>
                    <h5 className='text-[#121] md:text-base text-sm font-medium'>A12</h5>
                   </div>
                </div>
                <div className="col-span-6 flex items-center gap-x-2">
                    <div className='md:p-[5px] p-1 bg-[#EBF6F2] rounded-[4px]'>
                   ...
                   <div className='flex flex-col'>
                   <span className='text-[#121] md:text-xs text-[11px] font-semibold opacity-75'>Flight time</span>
                    <h5 className='text-[#121] md:text-base text-sm font-medium'>Newark(EWR)</h5>
                   </div>
                </div>
                <div className="col-span-6 flex items-center gap-x-2">
                    <div className='md:p-[5px] p-1 bg-[#EBF6F2] rounded-[4px]'>
                     <MdAirlineSeatReclineNormal fill='#8dd3bb' className='md:text-[22px] text-lg'/>
                    </div>
                   <div className='flex flex-col'>
                   <span className='text-[#121] md:text-xs text-[11px] font-semibold opacity-75'>Seat no.</span>
                    <h5 className='text-[#121] md:text-base text-sm font-medium'>128</h5>
                   </div>
                </div>
